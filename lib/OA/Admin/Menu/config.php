    ...
    switch ($accountType) {
        case OA_ACCOUNT_ADMIN:
            if ($GLOBALS['_MAX']['CONF']['ui']['dashboardEnabled']) {
               // $oMenu->add(new OA_Admin_Menu_Section("dashboard", 'Home', "dashboard.php", false, ""));
                $oMenu->add(new OA_Admin_Menu_Section("dashboard", 'Home', "plugins/adflexReport/adflexReport-index.php?entity=global&breakdown=history", false, "dashboard"));
                //$oMenu->addTo("dashboard", new OA_Admin_Menu_Section("stats-adflex", 'Report', "stats-adflex.php?entity=global&breakdown=history", false, "statistics"));                
                //$oMenu->addTo("dashboard", new OA_Admin_Menu_Section("apsg-global", 'StatsGraphs', "plugins/apStatsGraphsUI/index.php", false, "statistics"));
                $oMenu->addTo("dashboard", new OA_Admin_Menu_Section("adflexReport-index", 'Adflex', "plugins/adflexReport/adflexReport-index.php?entity=global&breakdown=history", false, "statistics"));
                //$oMenu->addTo("dashboard", new OA_Admin_Menu_Section("stats-conversions", 'Report graph', "stats-conversions.php", false, "statistics"));                
        ...
        case OA_ACCOUNT_MANAGER:
            ...
            $oMenu->add(new OA_Admin_Menu_Section("2", 'Stats', "stats.php", false, "statistics"));
                ...
                $oMenu->addTo("2.4.3.2", new OA_Admin_Menu_Section("2.4.3.2.1", 'DailyStats', "stats.php?entity=affiliate&breakdown=daily&affiliateid={affiliateid}&campaignid={campaignid}&bannerid={bannerid}&day={day}"));
                $oMenu->addTo("2", new OA_Admin_Menu_Section("report-index", 'AdvancedReports', "report-index.php", false, "statistics"));
                //$oMenu->addTo("2", new OA_Admin_Menu_Section("apsg-global", 'StatsGraphs', "plugins/apStatsGraphsUI/index.php", false, "statistics"));
            //tuannv add 19/11/2012    
            //menu publisher    
                $oMenu->add(new OA_Admin_Menu_Section("publisher", 'Publisher', "publisher-index.php", false, "publisher"));
                $oMenu->addTo("publisher", new OA_Admin_Menu_Section("publisher-index", 'Publisher : Introduction', "publisher-index.php", false, "", null, 1, false, 'g_website'));
                    //website add new
                        $oMenu->addTo("publisher", new OA_Admin_Menu_Section("website-index", 'Affiliates', "publisher-index.php", false, "inventory/publishersAndZones", null, 1, false, 'g_website'));
                        ...
                        //zone add new
                        $oMenu->addTo('publisher', new OA_Admin_Menu_Section('affiliate-zones', 'Zones', 'affiliate-zones.php', false, "inventory/publishersAndZones/zones", null, 1, false, 'g_website'));
                        ...
                        if (empty($aConf['ui']['disableDirectSelection'])) {
                            //$oMenu->addTo("publisher", new OA_Admin_Menu_Section("admin-generate", 'GenerateBannercode', "admin-generate.php", false, ""));
                        } 
                //$oMenu->addTo('publisher', new OA_Admin_Menu_Section('affiliate-channels', 'Channels', 'affiliate-channels.php', false, "publisher/publishersAndZones/channels", null, 1, false, 'g_website'));
                //$oMenu->addTo('affiliate-channels', new OA_Admin_Menu_Section('channel-edit-affiliate_new', 'AddNewChannel', 'channel-edit.php?affiliateid={affiliateid}', true, "publisher/publishersAndZones/channels/addChannel"));
                //$oMenu->addTo('affiliate-channels', new OA_Admin_Menu_Section('channel-edit-affiliate', 'ChannelProperties', 'channel-edit.php?affiliateid={affiliateid}&channelid={channelid}', false, "publisher/publishersAndZones/channels/editChannel"));
                //$oMenu->addTo('affiliate-channels', new OA_Admin_Menu_Section('channel-affiliate-acl', 'ChannelLimitations', 'channel-acl.php?affiliateid={affiliateid}&channelid={channelid}', false, "publisher/publishersAndZones/channels/editChannel/deliveryOptions"));
                
                $oMenu->addTo("publisher", new OA_Admin_Menu_Section("generate-code", 'Generate code', "generate-code.php", false, "generate"));
//end menu publisher
                        
              //menu adventiser          
                    $oMenu->add(new OA_Admin_Menu_Section("adventiser", 'Adventiser', "adventiser-index.php", false, "adventiser"));   
                    $oMenu->addTo("adventiser", new OA_Admin_Menu_Section("adventiser-index", 'Adventiser : Introduction', "adventiser-index.php", false, "", null, 1, false, 'g_adv'));
                    
//                        $oMenu->addTo("adventiser", new OA_Admin_Menu_Section("advertiser-index", 'Clients', "advertiser-index.php", false, "inventory", null, 1, false, 'g_adv'));
...
//                            $oMenu->addTo("advertiser-index", new OA_Admin_Menu_Section("advertiser-access", 'UserAccess', "advertiser-access.php?clientid={clientid}", false, ""));                    
                           ...
                           $oMenu->addTo("adventiser", new OA_Admin_Menu_Section("advertiser-campaigns", 'Campaigns', "advertiser-campaigns.php", false, "adventiser/advertiserAndCampaings/campaigns", null, 1, false, 'g_adv'));
                           $oMenu->addTo("advertiser-campaigns", new OA_Admin_Menu_Section("campaign-edit_new", 'AddCampaign', "campaign-edit.php?clientid={clientid}", true, "adventiser/advertiserAndCampaings/campaigns/addCampaign"));
                           $oMenu->addTo("advertiser-campaigns", new OA_Admin_Menu_Section("campaign-edit", 'CampaignProperties', "campaign-edit.php?clientid={clientid}&campaignid={campaignid}", false, "adventiser/advertisersAndCampaigns/campaigns/editCampaign"));
                           $oMenu->addTo("advertiser-campaigns", new OA_Admin_Menu_Section("campaign-zone", 'LinkedZones', "campaign-zone.php?clientid={clientid}&campaignid={campaignid}", false, "adventiser/advertisersAndCampaigns/campaigns/linkedZones"));
                           if ($aConf['logging']['trackerImpressions']) {
                               //$oMenu->addTo("advertiser-campaigns", new OA_Admin_Menu_Section("campaign-trackers", 'LinkedTrackers', "campaign-trackers.php?clientid={clientid}&campaignid={campaignid}", false, "adventiser/advertisersAndCampaigns/campaigns/linkedTrackers"));
                           }

                       $oMenu->addTo("adventiser", new OA_Admin_Menu_Section("campaign-banners", 'Banners', "campaign-banners.php", false, "adventiser/advertisersAndCampaigns/campaigns/banners", null, 1, false, 'g_adv'));
                           $oMenu->addTo("campaign-banners", new OA_Admin_Menu_Section("banner-edit_new", 'AddBanner', "banner-edit.php?clientid={clientid}&campaignid={campaignid}", true, "adventiser/advertisersAndCampaigns/campaigns/banners/addBanner"));
                           $oMenu->addTo("campaign-banners", new OA_Admin_Menu_Section("banner-edit", 'BannerProperties', "banner-edit.php?clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}", false, "adventiser/advertisersAndCampaigns/campaigns/banners/editBanner"));
                           ...
                           $oMenu->addTo("campaign-banners", new OA_Admin_Menu_Section("banner-acl", 'ModifyBannerAcl', "banner-acl.php?clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}", false, "adventiser/advertisersAndCampaigns/campaigns/banners/editBanner/deliveryOptions"));
                           $oMenu->addTo("campaign-banners", new OA_Admin_Menu_Section("banner-zone", 'LinkedZones', "banner-zone.php?clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}", false, "adventiser/advertisersAndCampaigns/campaigns/banners/editBanner/linkedZones"));
                           $oMenu->addTo("campaign-banners", new OA_Admin_Menu_Section("banner-advanced", 'Advanced', "banner-advanced.php?clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}", false, "adventiser/advertisersAndCampaigns/campaigns/banners/editBanner/convertFlashLinks"));                   
