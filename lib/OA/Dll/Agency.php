...
class OA_Dll_Agency extends OA_Dll
{
    ...
    function modify(&$oAgency)
    {
        ...
        $agencyData['website_url']   = $oAgency->websiteUrl;
        
        //$this->raiseError($agencyData['website_url']);
       // return false;        
        ...
        if ($this->_validate($oAgency)) {
            ...
            if (!isset($agencyData['agencyId'])) {
                ...
                //insert website to publisher
                $oAgency->agencyId = $doAgency->insert($agencyData['website_url']);
        ...
        //$this->raiseError($userId."____");
        //return false;                       
                    $userId = $oPlugin->saveUser($userId, $agencyData['username'], $agencyData['password'],
                        $agencyData['contactName'], $agencyData['userEmail'], $agencyData['language'], $oAgency->accountId, $agencyData['userAddress'], $agencyData['userPhone']);
