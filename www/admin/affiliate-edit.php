 ...
 function processForm($affiliateid, $form, $oComponent)
{
    ...
    $oPublisher->comments        = $aFields['comments'];
    ...
    //tuannv add 21/11/2012
                $doZones = OA_Dal::factoryDO('zones');
                $doZones->affiliateid = $oPublisher->publisherId;
                $doZones->zonename = 'zone-'.$aFields['agencyid'].'_'.$aFields['website'];
