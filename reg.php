...
$Agency   = new XML_RPC_Value(
           array(
					'agencyName' => new XML_RPC_Value($_POST['agencyName'],'string'),
					...
					'userEmail' => new XML_RPC_Value($_POST['emailAddress'], 'string'),
                                        ...
                                        //'language' => new XML_RPC_Value('en', 'string'),
                ),
                'struct'
                );
$aParams    = array(
