 ...
 */
class Plugins_DeliveryLimitations_Client_Brand extends Plugins_DeliveryLimitations_CommaSeparatedData
{
    ...
    function Plugins_DeliveryLimitations_Client_Brand()
    {
        $this->Plugins_DeliveryLimitations_ArrayData();        
        $this->setAValues($this->_brands);
        $this->nameEnglish = 'Brands';
    }
